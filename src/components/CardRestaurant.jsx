              ...
              <div className='p-4 space-y-10'>
                <div>
                  <div className='rounded-md flex flex-col'>
                    <h2 className='text-xl'>{place.storeName ? place.storeName.length > 30 ? place.storeName.substring(0,30) + "..." : place.storeName : null}</h2>
                    <p>Rating: {rating}&#9733;</p>
                  </div>
                  <div className='flex justify-between'>
                    <div className='flex w-1/2'>
                      <p>{place.address ? place.address.length > 20 ?  place.address.substring(0,15) + "...": place.address : "Surabaya"}{" - "}{place.price ? place.price : '$$'}</p>
                    </div>
                ...
                <div>
                  <Link to={`/details/${place.placeId}`} className='flex justify-center bg-blue-800 text-white p-2 rounded-md'>Learn More</Link>
                </div>
              </div> */}
